...
export const WishlistSetItem = ({ set, selectedParts, onPartToggle }: WishlistSetItemProps) => {
  ...
  return (
    <Card 
      className={cn(
        "transition-all duration-300 border-border/30",
          ...
          <div className="p-4 cursor-pointer">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                {selectedPartsInSet.length > 0 && (
                  <div className={cn(
                    "w-6 h-6 rounded-full border-2 bg-accent border-accent shadow-glow flex items-center justify-center shrink-0"
                  )}>
            ...
            <div className="space-y-2">
              {set.parts.map((part) => (
                ...
                >
                  ...
                  <div className={cn(
                    "w-5 h-5 rounded-full border-2 transition-all duration-200 flex items-center justify-center shrink-0",
                    selectedParts.has(part.id)
